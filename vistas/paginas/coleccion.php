    <header>
        <div class="col d-flex flex-column container-fluid justify-content-center align-items-center custom-bg1">
                <p class="p-title display-1">Aurora's Collection</p>
        </div>
    </header>
        ...
        <section>
            <div class="container pt-4">
                <div class="row p-4">
                    ...
                    <article class="col-12 col-md-12 col-lg-4 px-4 mt-5 border-card">
                        <div class="card">
            ...
            <div class="container">
                <div class="row p-4">
                    ...
                    <article class="col-12 col-md-12 col-lg-4 px-4 mt-5 border-card pb-4">
                        <div class="card">
