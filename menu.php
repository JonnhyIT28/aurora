...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="menu-resp.css">
    <link rel="stylesheet" type="text/css" href="art-resp.css">
...
<div class="fixed-top menu-resp">
    <div class="container-fluid bg-color border-bottom">
        <div class="d-flex pt-1 justify-content-around container text-light pl-2">
            ...
            <p class="h6 menu-resp">Envios gratis a todo el pais superando los $18.999 !</p>
        ...
        <div class="d-flex justify-content-around container text-light pt-2"> 
            ...
            <nav>
                <ul class="nav nav-pills px-4">
                    <li class="nav-item">
                        <a href="collection.php" class="link-menu menu-resp hover-op nav-link">Shop All</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="ropa.php" class="link-menu menu-resp hover-op nav-link">Clothing</a>
                    </li>
                    <li class="nav-item">
                        <a href="accesorios.php" class="link-menu link-menu-resp hover-op nav-link">Accesorios</a>
                    </li>
                </ul>
            </nav>
