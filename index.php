                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 p-0">
                            <a href="ropa.php">
                                <div class="position-r overflow-hidden">
                                    <img class="hover-op img-fluid" src="imagenes/libros1.jpg" alt="Libros" width="100%">
                        ...
                        <div class="col-12 col-lg-6 p-0">
                            <a href="accesorios.php">
                                <div class="position-r overflow-hidden">
                                    <img class="hover-op img-fluid" src="imagenes/reading.png" alt="Accesorios" width="100%">
                                    <div class="position-a top-0 start-0 pointer-events-n">
